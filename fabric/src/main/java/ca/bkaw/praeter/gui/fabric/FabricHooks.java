...
public class FabricHooks {
    ...
    public static void renderItem(RenderContext r, SlotPos pos, Function<CustomGui, @Nullable ItemStack> itemFunction) {
        CommonHooks.renderGuiItem(r, pos, gui -> FabricGuiItem.of(itemFunction.apply(gui)));
    }
    ...
    public static ItemStack getSlotItem(Ref<Slot> slotRef, CustomGui gui) {
        return FabricGuiItem.toItemStack(slotRef.get(gui).getGuiItem());
    }
    ...
    public static ItemStack getSlotItem(Slot slot) {
        return FabricGuiItem.toItemStack(slot.getGuiItem());
    }
    ...
    public static void setSlotItem(Ref<Slot> slotRef, CustomGui gui, @Nullable ItemStack itemStack) {
        slotRef.get(gui).setGuiItem(FabricGuiItem.of(itemStack));
    }
    ...
    public static void setSlotItem(Slot slot, @Nullable ItemStack itemStack) {
        slot.setGuiItem(FabricGuiItem.of(itemStack));
    }
     ...
     */
    public static void onClick(CustomGui gui, Consumer<FabricClickContext> action) {
        CommonHooks.commonOnClick(gui, ctx -> action.accept((FabricClickContext) ctx));
    }
     ...
     * @param action The listener.
     */
    public static void onClick(CustomGui gui, Iterable<SlotPos> pos, Consumer<FabricClickContext> action) {
        CommonHooks.commonOnClick(gui, pos, ctx -> action.accept((FabricClickContext) ctx));
    }
     ...
     * @param action The listener.
     */
    public static void onClick(RenderContext r, Consumer<FabricClickContext> action) {
        CommonHooks.commonOnClick(r, ctx -> action.accept((FabricClickContext) ctx));
    }
     ...
     * @param action The listener.
     */
    public static void onClick(RenderContext r, Iterable<SlotPos> pos, Consumer<FabricClickContext> action) {
        CommonHooks.commonOnClick(r, pos, ctx -> action.accept((FabricClickContext) ctx));
    }
     ...
     */
    public static <T extends Iterable<SlotPos>> void onClick(RenderContext r, Ref<T> posRef, Consumer<FabricClickContext> action) {
        CommonHooks.commonOnClick(r, posRef, ctx -> action.accept((FabricClickContext) ctx));
    }
}
